...
const { Client, Collection, Events, GatewayIntentBits } = await import('discord.js');
...
client.commands.set(betCommand.data.name, betCommand);
commands.push(sitCommand.data.toJSON())
commands.push(betCommand.data.toJSON())
